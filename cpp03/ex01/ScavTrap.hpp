...
class ScavTrap : public ClapTrap
{
    ...
    public:
		...
		ScavTrap(std::string name) : name(name), hit(100), energy(50), attack_damage(20) {std::cout << "ClapTrap constructor called" << std::endl;};
        ~ScavTrap(void) {std::cout << "ClapTrap destructor called" << std::endl;};
};
